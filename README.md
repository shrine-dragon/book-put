...
読んだ本について「アウトプット」として投稿できる読書発信アプリ兼、
他のユーザーの投稿内容を閲覧して、素敵な本と出会えるきっかけを作る読書アプリ。
...
②投稿の詳細を閲覧でき、そのページではコメントを投稿したり、お気に入りに登録したり、ボタンを押して好評価したりできる。

# 制作背景

## ペルソナ

- 読書を趣味にしたいと思っていて、読みたい本を探しているが見つからず、実際に買って読む勇気が持てない人。

- 読書を趣味としていて、面白い本をたくさん読みたいと思っているが、探すための情報源が無くて困っている人。

- ビジネス書や自己啓発本など、勉強目的で読書を習慣としているが、いつも読んだだけで終わってしまい（インプット）、学んだ内容を発信（アウトプット）できていない人。
...
理由
- 全てのページの中で、一番目につくページであり、デザインやレイアウトがダサいとユーザーにアプリを使ってもらえないため。

実装方法
- コードを記述する前に、ページ全体の設計図を、紙に下書きとして書いていく。
- フリマアプリなど、今まで作成したアプリやその他のwebサイトを参考にして、気に入った部分を自身のアプリに取り入れる。
